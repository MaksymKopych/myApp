    ...
    return (
        ...
        <div className="form-contener">
          ...
          <div className="form-content">
            ...
            <MyInput onChange={e=> setUser({...user, last_name: e.target.value})} value={user.last_name} id="last_name" name="last_name" type="text" />
          </div>
          <div className="form-content">
            <label htmlFor="email">Email:</label>
            <MyInput onChange={e=> setUser({...user, email: e.target.value})} value={user.email} id="email" name="emale" type="email" />
          </div>
